...
The pre-stack seismic data can be viewed as a 5D data or a fifth order *tensor* consisting of one time or frequency dimension and four spatial dimensions describing the location of the detector and the receiver in a two dimensional plane. This data can then be described in terms of the original ($r_x$, $r_y$, $s_x$, $s_y$) coordinate frames or in terms of midpoint receivers and offsets ($x$, $y$, $h_x$, $h_y$). Alternatively, one can also view this data as a collection of 4D tensors across the temporal frequencies as con- sidered in [Trad (2009)] and [Kreimer and Sacchi (2011)].
